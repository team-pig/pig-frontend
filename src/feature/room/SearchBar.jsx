...
//     }
//     joinModal();
//     console.log("join", searchContent);
//   };
//   const openAddModal = (e) => {
//     if (searchContent.length > 0) {
//       setSearchContent("");
...
//     }
//     addModal();
//     console.log("add", searchContent);
//   };

//   const changeSearchContent = (e) => {
//     dispatch(__searchRoom(e.target.value));
//     console.log("검색디스패치");
//     setSearchContent(e.target.value);
//   };

//   const delay = _.debounce(changeSearchContent, 50);
...
//               </IconBox>
//               <IconBox>
//                 <Icon icon="enter" size="24px" onClick={openJoinModal} />
//               </IconBox>
//               <IconBox>
//                 <Icon icon="plus-lg" size="24px" onClick={openAddModal} />
//               </IconBox>
//             </IconSet>
//           )}
//         </WrapperMobileItem>
...
//             </Button>
//             <BtnBox>
//               <Button shape="green-outline" size="150" onClick={openAddModal}>
//                 <Btn>
//                   <BtnContent>
//                     <Icon icon="plus-lg" size="24px" />
//                     <Span>방 만들기</Span>
